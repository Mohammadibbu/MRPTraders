      ...
      case 'card':
        return (
          <div className={`bg-white rounded-xl shadow-lg p-6 ${className}`}>
            <ShimmerEffect height="h-48" borderRadius="rounded-lg" className="mb-4" />
            <ShimmerEffect height="h-6" width="w-3/4" className="mb-2" />
            <ShimmerEffect height="h-4" width="w-1/2" className="mb-4" />
      ...
      case 'product':
        return (
          <div className={`bg-white rounded-xl shadow-lg overflow-hidden ${className}`}>
            <ShimmerEffect height="h-48" borderRadius="rounded-none" />
            <div className="p-6">
              <ShimmerEffect height="h-6" width="w-3/4" className="mb-2" />
              <ShimmerEffect height="h-8" width="w-1/2" className="mb-4" />
      ...
      case 'avatar':
        return (
          <div className={`flex items-center space-x-4 ${className}`}>
            <ShimmerEffect width="w-12" height="h-12" borderRadius="rounded-full" />
          ...
          <div className={`space-y-4 ${className}`}>
            {Array.from({ length: 3 }).map((_, index) => (
              <div key={index} className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg">
                <ShimmerEffect width="w-16" height="h-16" borderRadius="rounded-lg" />
                <div className="flex-1 space-y-2">
                  <ShimmerEffect height="h-4" width="w-3/4" />
                  <ShimmerEffect height="h-3" width="w-1/2" />
                </div>
                <ShimmerEffect width="w-20" height="h-8" borderRadius="rounded-lg" />
              </div>
            ))}
          </div>
        );
