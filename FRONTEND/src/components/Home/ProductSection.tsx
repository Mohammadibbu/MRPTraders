        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          {categoriesToDisplay.map((category) => (
            <Link
              key={category.id}
              to={category.link}
              className="block bg-white rounded-lg shadow-md hover:shadow-xl transform hover:-translate-y-2 hover:bg-secondarylight transition-all duration-300 overflow-hidden"
            >
