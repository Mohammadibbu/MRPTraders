    ...
    showToastPromise(
...

      {
        ...
        error: (err: { message: string; error: any }) =>
          ` ${err?.message || "Something went wrong!"}`, // You can use the error passed from the reject
      },
      4000
    );
  };
      ...
      <section className="py-20 relative ">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-[11]">
          ...
          <p className="text-xl text-gray-200">
            Get in touch with our trade specialists for personalized assistance
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Ready to start your global trading journey? Our team is here to
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-gray-700 mb-2"
                >
                  Message <span className="text-primary font-extrabold">*</span>
                </label>
                <textarea
                  id="message"
                  name="message"
              ...
              <button
                type="submit"
                className="disabled:cursor-wait  w-full bg-gradient-to-r from-primary to-secondary text-white py-3 px-6 rounded-lg font-semibold hover:shadow-lg transition-all duration-200 flex items-center justify-center space-x-2"
                disabled={loading}
              >
